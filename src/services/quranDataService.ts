const SURAH_NAMES: Record<number, string> = {
  ...
  71: "نوح", 72: "الجن", 73: "المزمل", 74: "المدثر", 75: "القيامة", 76: "الانسان", 77: "المرسلات", 78: "النبأ", 79: "النازعات", 80: "عبس",
...
export class QuranDataService {
  ...
  static async fetchVerifiedVerse(surahNumber: number, ayahNumber: number): Promise<string> {
    ...
    try {
      ...
      console.warn(`Error fetching verified verse ${surahNumber}:${ayahNumber}:`, error);
      // Return empty string on failure or timeout so the caller knows it failed and can fall back
      return "";
    }
  }
